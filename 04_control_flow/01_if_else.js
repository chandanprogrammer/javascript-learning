/* -------- Conditional Statements : (control flow or logic flow) -------- */
...
/* using Ternary operator --> it is a shorthand way to write conditional statements in programming languages.*/
temperature === 40
  ? console.log("Temperature is 40")
  : console.log("Temperature is not 40");
